...
class AppColor {
  ...
  static Color screenBgColor = Colors.white;

  static Color primaryColor = const Color(0xff014510);

  static Color bgPrimaryColor = const Color(0xff014510);

  static const Color backgroundColor = Colors.white;

  static const Color appTitleTextColor =  Colors.black;
  ...
  static const linkTextColor = Color.fromARGB(255, 31, 70, 209);  // 1F40B5
  ...
  static const Color txtFldTitleTextColor =  Color(0xff1E232C);

  static const Color hintTitleTextColor =  Color(0xff8391A1);

  static const Color textFiledBgColor = Color(0xffF7F8F9);
  ...
  static final Color  otpFocusBorderColor = const Color(0xff0073C5).withOpacity(0.50);
